...
describe('Wingman data service', () => {
  ...
  it('Should be a able to select a flight by its id', () => {
    const expectedFlight = {
      flightId: 'FPG034707',
      mainBookingId: 'PG168708',
      flightDescription: null,
      route: 'MH-D(8:45)-TC-BM',
      airTime: 1.55,
      flightTime: 1.75,
      startDate: '2020-03-09T08:42:00',
      aircraftId: 'AC000033',
      homeBaseId: 'AS000394',
      pilotId: 'CR003926',
      coPilotId: null,
      ...
      legs: [
        {
          ...
          offBlock: '2020-03-09T08:42',
          takeoff: '2020-03-09T08:45',
          landing: '2020-03-09T10:05',
          onBlock: '2020-03-09T10:08',
          estimate: false,
          airTime: 1.33
        },
        {
          meetingTime: '2020-03-09T08:32',
          meetingTimeFixed: false,
          timeOnGround: 'PT40M',
          timeOnGroundFixed: false,
          nightStop: 0,
          ...
          offBlock: '2020-03-09T10:27',
          takeoff: '2020-03-09T10:30',
